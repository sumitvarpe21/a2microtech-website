    ...
    <main className="about-page">
      ...
      <section className="about-hero">
        ...
        <p className="about-intro">
          A2 Microtech provides electronics, technology
          products and development solutions for students,
          developers, businesses and technology enthusiasts.
        </p>
      </section>
      ...
      <section className="about-story">
        ...
        <div className="about-story-content">
          ...
          <p>
            A2 Microtech is focused on providing electronic
            components, development boards, sensors,
            accessories and technology solutions.
          </p>

          <p>
            From individual components to complete technology
            solutions, our goal is to make the products and
            support needed for innovation more accessible.
          </p>
        </div>
