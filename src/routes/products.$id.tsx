...
export const Route = createFileRoute("/products/$id")({
  head: ({ params }) => {
    ...
    const title = product ? `${product.name} — A2 Microtech` : "Product — A2 Microtech";
    const description = product
      ? product.description
      : "Product details at A2 Microtech.";
    return {
      meta: [
        { title },
      ...
      <section className="product-details">
        ...
        <div className="product-details-info">
          ...
          <div className="product-actions">
            ...
            <button className="wishlist-detail" aria-label="Add to wishlist">
              <Heart size={20} />
            </button>
          </div>
