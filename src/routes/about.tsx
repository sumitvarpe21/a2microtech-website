...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About — A2 Microtech" },
      {
        name: "description",
        content:
          "A2 Microtech provides electronics, technology products and development solutions for students, developers, businesses and technology enthusiasts.",
      },
      { property: "og:title", content: "About — A2 Microtech" },
      {
