...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact — A2 Microtech" },
      {
        name: "description",
        content:
          "Have a question about our products, services or technology solutions? Get in touch with the A2 Microtech team.",
      },
      { property: "og:title", content: "Contact — A2 Microtech" },
      {
      ...
      <section className="contact-layout">
        <div className="contact-information">
          ...
          <p className="contact-description">
            Whether you need electronic components, technology solutions, project support or have
