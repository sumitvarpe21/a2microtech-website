...
import { homeCategories, logo, products } from "@/data/products";

export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "A2 Microtech — Technology Built for You" },
      {
        name: "description",
        content:
          "Explore quality electronic components, technology products and solutions designed for modern needs.",
      },
      { property: "og:title", content: "A2 Microtech — Technology Built for You" },
      {
      ...
      <section className="hero">
        <div className="hero-content">
          ...
          <p className="hero-description">
            Explore quality electronic components, technology products and solutions designed
            for modern needs.
          </p>
