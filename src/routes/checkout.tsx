...
export const Route = createFileRoute("/checkout")({
  head: () => ({
    meta: [
      { title: "Checkout — A2 Microtech" },
      { name: "description", content: "Complete your A2 Microtech order." },
      { property: "og:title", content: "Checkout — A2 Microtech" },
      { property: "og:description", content: "Complete your A2 Microtech order." },
    ],
  }),
  component: Checkout,
});
